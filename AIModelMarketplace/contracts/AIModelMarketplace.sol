...
import "./UniversityGroupToken.sol";

contract AIModelMarketplace {
    UniversityGroupToken public token;
    ...
    constructor(address _tokenAddress) {
        token = UniversityGroupToken(_tokenAddress);
    }
    ...
    function purchaseModel(uint256 modelId) public {
        ...
        require(allowance >= model.price, "Insufficient token allowance");
